...
// include: /var/folders/0q/mk7nk66n7jz67x0_cbr3tdxc0000gn/T/tmpzbn5q8pr.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'bin/SoftwareRenderer.data';
      var REMOTE_PACKAGE_BASE = 'SoftwareRenderer.data';
...
Module['FS_createPath']("/", "models", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_bin/SoftwareRenderer.data');
      }
      Module['addRunDependency']('datafile_bin/SoftwareRenderer.data');
    ...
    loadPackage({"files": [{"filename": "/fonts/OpenSans.ttf", "start": 0, "end": 529700}, {"filename": "/models/Chicken.obj", "start": 529700, "end": 581061}, {"filename": "/models/ChickenTexture.png", "start": 581061, "end": 664808}, {"filename": "/models/monkey.obj", "start": 664808, "end": 727833}, {"filename": "/models/suzanne.obj", "start": 727833, "end": 790879}, {"filename": "/models/suzanneTexture.png", "start": 790879, "end": 830067}], "remote_package_size": 830067});

  })();

// end include: /var/folders/0q/mk7nk66n7jz67x0_cbr3tdxc0000gn/T/tmpzbn5q8pr.js
// include: /var/folders/0q/mk7nk66n7jz67x0_cbr3tdxc0000gn/T/tmpopji7l_s.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/0q/mk7nk66n7jz67x0_cbr3tdxc0000gn/T/tmpopji7l_s.js
// include: /var/folders/0q/mk7nk66n7jz67x0_cbr3tdxc0000gn/T/tmp3z3sthub.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/0q/mk7nk66n7jz67x0_cbr3tdxc0000gn/T/tmp3z3sthub.js
...
function findWasmBinary() {
  return locateFile('SoftwareRenderer.wasm');
}
...
var ASM_CONSTS = {
  126989: () => { if (document.fullscreenElement) return 1; },  
 127035: () => { return Module.canvas.width; },  
 127067: () => { return parseInt(Module.canvas.style.width); },  
 127115: () => { document.exitFullscreen(); },  
 127142: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 127214: () => { if (document.fullscreenElement) return 1; },  
 127260: () => { return Module.canvas.width; },  
 127292: () => { return screen.width; },  
 127317: () => { document.exitFullscreen(); },  
 127344: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 127477: () => { return window.innerWidth; },  
 127503: () => { return window.innerHeight; },  
 127530: () => { if (document.fullscreenElement) return 1; },  
 127576: () => { return Module.canvas.width; },  
 127608: () => { return parseInt(Module.canvas.style.width); },  
 127656: () => { if (document.fullscreenElement) return 1; },  
 127702: () => { return Module.canvas.width; },  
 127734: () => { return screen.width; },  
 127759: () => { return window.innerWidth; },  
 127785: () => { return window.innerHeight; },  
 127812: () => { if (document.fullscreenElement) return 1; },  
 127858: () => { return Module.canvas.width; },  
 127890: () => { return screen.width; },  
 127915: () => { document.exitFullscreen(); },  
 127942: () => { if (document.fullscreenElement) return 1; },  
 127988: () => { return Module.canvas.width; },  
 128020: () => { return parseInt(Module.canvas.style.width); },  
 128068: () => { document.exitFullscreen(); },  
 128095: ($0) => { Module.canvas.style.opacity = $0; },  
 128133: () => { return screen.width; },  
 128158: () => { return screen.height; },  
 128184: () => { return window.screenX; },  
 128211: () => { return window.screenY; },  
 128238: () => { return window.devicePixelRatio; },  
 128274: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 128327: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 128378: () => { Module.canvas.style.cursor = 'none'; },  
 128415: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 128671: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 128722: () => { if (document.pointerLockElement) return 1; },  
 128769: () => { if (document.fullscreenElement) return 1; },  
 128815: () => { return window.innerWidth; },  
 128841: () => { return window.innerHeight; }
};
